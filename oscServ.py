...
class oscServerGuy(object):
  def __init__(self, savedOSC):
    ...
    self.oscServer.addMsgHandler("/test", self.callBack)
    ...
    self.oscServer.addMsgHandler("/s/attack/param" , self.callBack)
    self.oscServer.addMsgHandler("/s/decay/param" , self.callBack)
    self.oscServer.addMsgHandler("/s/volume/param" , self.callBack)
    self.oscServer.addMsgHandler("/s/modfreq/param" , self.callBack)
    self.oscServer.addMsgHandler("/s/selectKnob" , self.callBack)
